...
func NewShido(
	...
	keys := sdk.NewKVStoreKeys(
		...
		distrtypes.StoreKey, slashingtypes.StoreKey, minttypes.StoreKey,
	...
	*/
	...
	app.setAnteHandler(encodingConfig.TxConfig, maxGasWanted, wasmConfig, keys[wasmtypes.StoreKey])
	app.setPostHandler()
