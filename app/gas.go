...
var (
	// MainnetMinGasPrices defines 20B ashido (or atshido) as the minimum gas price value on the fee market module.
	// See https://commonwealth.im/shido/discussion/5073-global-min-gas-price-value-for-cosmos-sdk-and-evm-transaction-choosing-a-value for reference
