...
var _ shidotypes.EVMTxIndexer = &KVIndexer{}
...
func (kv *KVIndexer) GetByTxHash(hash common.Hash) (*shidotypes.TxResult, error) {
...
func (kv *KVIndexer) GetByBlockAndIndex(blockNumber int64, txIndex int32) (*shidotypes.TxResult, error) {
...
func saveTxResult(codec codec.Codec, batch dbm.Batch, txHash common.Hash, txResult *shidotypes.TxResult) error {
