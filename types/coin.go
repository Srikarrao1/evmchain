...
// NewShidoCoin is a utility function that returns an "shido" coin with the given sdkmath.Int amount.
// The function will panic if the provided amount is negative.
func NewShidoCoin(amount sdkmath.Int) sdk.Coin {
	return sdk.NewCoin(AttoShido, amount)
}

// NewShidoDecCoin is a utility function that returns an "shido" decimal coin with the given sdkmath.Int amount.
// The function will panic if the provided amount is negative.
func NewShidoDecCoin(amount sdkmath.Int) sdk.DecCoin {
	return sdk.NewDecCoin(AttoShido, amount)
}

// NewShidoCoinInt64 is a utility function that returns an "shido" coin with the given int64 amount.
// The function will panic if the provided amount is negative.
