...
func init() {
	proto.RegisterType((*V3GenesisState)(nil), "shido.claims.v1.V3GenesisState")
	proto.RegisterType((*V3Params)(nil), "shido.claims.v1.V3Params")
}

func init() { proto.RegisterFile("shido/claims/v1/genesis.proto", fileDescriptor_f2f8f1d6f18af278) }
