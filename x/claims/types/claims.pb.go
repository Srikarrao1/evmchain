...
// source: shido/claims/v1/claims.proto
...
func (Action) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_07602070a01875dd, []int{0}
}
...
type Claim struct {
	// action enum
	Action Action `protobuf:"varint,1,opt,name=action,proto3,enum=shido.claims.v1.Action" json:"action,omitempty"`
...
func (*ClaimsRecordAddress) Descriptor() ([]byte, []int) {
	return fileDescriptor_07602070a01875dd, []int{1}
}
...
func (*ClaimsRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_07602070a01875dd, []int{2}
}
...
func init() {
	proto.RegisterEnum("shido.claims.v1.Action", Action_name, Action_value)
	proto.RegisterType((*Claim)(nil), "shido.claims.v1.Claim")
	proto.RegisterType((*ClaimsRecordAddress)(nil), "shido.claims.v1.ClaimsRecordAddress")
	proto.RegisterType((*ClaimsRecord)(nil), "shido.claims.v1.ClaimsRecord")
}

func init() { proto.RegisterFile("shido/claims/v1/claims.proto", fileDescriptor_07602070a01875dd) }

var fileDescriptor_07602070a01875dd = []byte{
	...
	,
}
