...
// source: shido/epochs/v1/query.proto
...
func (*QueryEpochsInfoRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_e4265dab7fbbe845, []int{0}
}
...
func (*QueryEpochsInfoResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_e4265dab7fbbe845, []int{1}
}
...
func (*QueryCurrentEpochRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_e4265dab7fbbe845, []int{2}
}
...
func (*QueryCurrentEpochResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_e4265dab7fbbe845, []int{3}
}
...
func init() {
	proto.RegisterType((*QueryEpochsInfoRequest)(nil), "shido.epochs.v1.QueryEpochsInfoRequest")
	proto.RegisterType((*QueryEpochsInfoResponse)(nil), "shido.epochs.v1.QueryEpochsInfoResponse")
	proto.RegisterType((*QueryCurrentEpochRequest)(nil), "shido.epochs.v1.QueryCurrentEpochRequest")
	proto.RegisterType((*QueryCurrentEpochResponse)(nil), "shido.epochs.v1.QueryCurrentEpochResponse")
}

func init() { proto.RegisterFile("shido/epochs/v1/query.proto", fileDescriptor_e4265dab7fbbe845) }

var fileDescriptor_e4265dab7fbbe845 = []byte{
	// 449 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *queryClient) EpochInfos(ctx context.Context, in *QueryEpochsInfoRequest, opts ...grpc.CallOption) (*QueryEpochsInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/shido.epochs.v1.Query/EpochInfos", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) CurrentEpoch(ctx context.Context, in *QueryCurrentEpochRequest, opts ...grpc.CallOption) (*QueryCurrentEpochResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/shido.epochs.v1.Query/CurrentEpoch", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_EpochInfos_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/shido.epochs.v1.Query/EpochInfos",
	}
...
func _Query_CurrentEpoch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/shido.epochs.v1.Query/CurrentEpoch",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "shido.epochs.v1.Query",
	...
	Metadata: "shido/epochs/v1/query.proto",
}
