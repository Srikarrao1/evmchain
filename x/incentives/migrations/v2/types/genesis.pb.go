...
// source: shido/V2Incentives/v1/genesis.proto
...
func init() {
	proto.RegisterType((*V2GenesisState)(nil), "shido.V2Incentives.v1.V2GenesisState")
	proto.RegisterType((*V2Params)(nil), "shido.V2Incentives.v1.V2Params")
}

func init() {
	proto.RegisterFile("shido/V2Incentives/v1/genesis.proto", fileDescriptor_7bb1f7c7e8ad160b)
}
