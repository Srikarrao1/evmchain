...
// source: shido/V2Incentives/v1/V2Incentives.proto
...
func init() {
	proto.RegisterType((*V2Incentive)(nil), "shido.V2Incentives.v1.V2Incentive")
	proto.RegisterType((*V2GasMeter)(nil), "shido.V2Incentives.v1.V2GasMeter")
	proto.RegisterType((*RegisterV2IncentiveProposal)(nil), "shido.V2Incentives.v1.RegisterV2IncentiveProposal")
	proto.RegisterType((*CancelV2IncentiveProposal)(nil), "shido.V2Incentives.v1.CancelV2IncentiveProposal")
}

func init() {
	proto.RegisterFile("shido/V2Incentives/v1/V2Incentives.proto", fileDescriptor_95b81e40854aec77)
}
