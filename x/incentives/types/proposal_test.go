	...
	testCases := []struct {
	...
	}{
		{
			...
			types.Incentive{
				...
				sdk.DecCoins{sdk.NewDecCoinFromDec("ashido", sdk.NewDecWithPrec(5, 2))},
				10,
				time.Now(),
				0,
			},
		...
		},
		{
			...
			types.Incentive{
				utiltx.GenerateAddress().String(),
				sdk.DecCoins{sdk.NewDecCoinFromDec("ashido", sdk.NewDecWithPrec(101, 2))},
				10,
				time.Now(),
				0,
			},
		...
		},
		{
			...
			types.Incentive{
				utiltx.GenerateAddress().String(),
				sdk.DecCoins{sdk.NewDecCoinFromDec("ashido", sdk.NewDecWithPrec(0, 2))},
				10,
				time.Now(),
				0,
			},
