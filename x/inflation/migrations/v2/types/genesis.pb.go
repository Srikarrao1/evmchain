...
func init() {
	proto.RegisterType((*V2GenesisState)(nil), "shido.inflation.v1.V2GenesisState")
	proto.RegisterType((*V2Params)(nil), "shido.inflation.v1.V2Params")
}

func init() { proto.RegisterFile("shido/inflation/v1/genesis.proto", fileDescriptor_1cb8eee530db1235) }
