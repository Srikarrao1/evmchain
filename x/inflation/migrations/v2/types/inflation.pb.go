...
// The initial V2InflationDistribution can be calculated from the Shido Token
// Model like this:
...
func init() {
	proto.RegisterType((*V2InflationDistribution)(nil), "shido.inflation.v1.V2InflationDistribution")
	proto.RegisterType((*V2ExponentialCalculation)(nil), "shido.inflation.v1.V2ExponentialCalculation")
}

func init() {
	proto.RegisterFile("shido/inflation/v1/inflation.proto", fileDescriptor_d064cb35c3ff7df8)
}
