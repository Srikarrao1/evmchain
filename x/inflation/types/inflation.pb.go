...
// source: shido/inflation/v1/inflation.proto
...
// The initial InflationDistribution can be calculated from the Shido Token
// Model like this:
...
func (*InflationDistribution) Descriptor() ([]byte, []int) {
	return fileDescriptor_74c987949d6d9419, []int{0}
}
...
func (*ExponentialCalculation) Descriptor() ([]byte, []int) {
	return fileDescriptor_74c987949d6d9419, []int{1}
}
...
func init() {
	proto.RegisterType((*InflationDistribution)(nil), "shido.inflation.v1.InflationDistribution")
	proto.RegisterType((*ExponentialCalculation)(nil), "shido.inflation.v1.ExponentialCalculation")
}

func init() {
	proto.RegisterFile("shido/inflation/v1/inflation.proto", fileDescriptor_74c987949d6d9419)
}

var fileDescriptor_74c987949d6d9419 = []byte{
	// 370 bytes of a gzipped FileDescriptorProto
	,
}
