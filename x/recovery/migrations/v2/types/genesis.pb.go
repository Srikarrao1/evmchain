...
func init() {
	proto.RegisterType((*V2GenesisState)(nil), "shido.recovery.v1.V2GenesisState")
	proto.RegisterType((*V2Params)(nil), "shido.recovery.v1.V2Params")
}

func init() { proto.RegisterFile("shido/recovery/v1/genesis.proto", fileDescriptor_8a3e70cb61e26f25) }
