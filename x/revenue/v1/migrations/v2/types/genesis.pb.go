...
func init() {
	proto.RegisterType((*V2GenesisState)(nil), "shido.revenue.v1.V2GenesisState")
	proto.RegisterType((*V2Params)(nil), "shido.revenue.v1.V2Params")
}

func init() { proto.RegisterFile("shido/revenue/v1/genesis.proto", fileDescriptor_649d64d9c3438055) }
