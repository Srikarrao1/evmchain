...
// source: shido/vesting/v2/vesting.proto
...
func init() {
	proto.RegisterType((*ClawbackVestingAccount)(nil), "shido.vesting.v2.ClawbackVestingAccount")
	proto.RegisterType((*ClawbackProposal)(nil), "shido.vesting.v2.ClawbackProposal")
}

func init() { proto.RegisterFile("shido/vesting/v2/vesting.proto", fileDescriptor_8846751a735fc006) }
