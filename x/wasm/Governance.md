...
For details see the proposal type [implementation](https://github.com/shido/shido/v2/blob/master/x/wasm/types/proposal.go)

### Unit tests
[Proposal type validations](https://github.com/shido/shido/v2/blob/master/x/wasm/types/proposal_test.go)

## Proposal Handler
The [wasmd proposal_handler](https://github.com/shido/shido/v2/blob/master/x/wasm/keeper/proposal_handler.go) implements the `gov.Handler` function
and executes the wasmd proposal types after a successful tally.
 
The proposal handler uses a [`GovAuthorizationPolicy`](https://github.com/shido/shido/v2/blob/master/x/wasm/keeper/authz_policy.go#L29) to bypass the existing contract's authorization policy.

### Tests
* [Integration: Submit and execute proposal](https://github.com/shido/shido/v2/blob/master/x/wasm/keeper/proposal_integration_test.go)

## Gov Integration
The wasmd proposal handler can be added to the gov router in the [abci app](https://github.com/shido/shido/v2/blob/master/app/app.go#L306)
...
See [params.go](https://github.com/shido/shido/v2/blob/master/x/wasm/types/params.go)
...
```
-X github.com/shido/shido/v2/app.ProposalsEnabled=true - enable all x/wasm governance proposals (default false)
-X github.com/shido/shido/v2/app.EnableSpecificProposals=MigrateContract,UpdateAdmin,ClearAdmin - enable a subset of the x/wasm governance proposal types (overrides ProposalsEnabled)
```

The `ParamChangeProposal` is always enabled.

### Tests
* [params validation unit tests](https://github.com/shido/shido/v2/blob/master/x/wasm/types/params_test.go)
* [genesis validation tests](https://github.com/shido/shido/v2/blob/master/x/wasm/types/genesis_test.go)
* [policy integration tests](https://github.com/shido/shido/v2/blob/master/x/wasm/keeper/keeper_test.go)
...
```
## Rest
New [`ProposalHandlers`](https://github.com/shido/shido/v2/blob/master/x/wasm/client/proposal_handler.go)
...
```
In [abci app](https://github.com/shido/shido/v2/blob/master/app/app.go#L109)

### Tests
* [Rest Unit tests](https://github.com/shido/shido/v2/blob/master/x/wasm/client/proposal_handler_test.go)
* [Rest smoke LCD test](https://github.com/shido/shido/v2/blob/master/lcd_test/wasm_test.go)



## Pull requests
* https://github.com/shido/shido/v2/pull/190
* https://github.com/shido/shido/v2/pull/186
* https://github.com/shido/shido/v2/pull/183
* https://github.com/shido/shido/v2/pull/180
* https://github.com/shido/shido/v2/pull/179
* https://github.com/shido/shido/v2/pull/173
